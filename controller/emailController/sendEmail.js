...
const sendEmail = async (subject, data, html) => {
    ...
    try{
        ...
        await transporter.sendMail({
            ...
            to: html ? email : process.env.MY_EMAIL,//Recipient's email address...
            subject: subject, 
            html: html ? htmlTamplate(name, email) : undefined, //HTML content (conditional base on 'html' parameter)
            text: html ? undefined : `${name}: ${message}.\nCorreo del cliente: ${email}`, //Plain text content (conditional based on 'html' parameter)
        }); 
